...
{
    enum variables { v, w, i, t};
    enum parameters { a, b, tau, Idc, Iamp, Ifreq, Idel, Idf, symmetry, signal, method, COUNT};
...
__host__ __device__ __forceinline__ void finiteDifferenceScheme_(name)(numb* currentV, numb* nextV, numb* parameters)
{
    const numb h = H;
    const int N = 3;
    numb v[N] = { V(v), V(w), V(t) };
    const numb p[9] = { P(a), P(b), P(tau), P(Idc), P(Iamp), P(Idel), P(Idf), P(Ifreq), P(symmetry) };
    ...
    ifSIGNAL(P(signal), square)
    {
        ...
        {
			numb I = p[3] + (fmod((v[2] - p[5]) > (numb)0.0 ? (v[2] - p[5]) : (p[6] / p[7] + p[5] - v[2]), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);
            Vnext(t) = v[2] + h;
            Vnext(v) = v[0] + h * (v[0] - (v[0] * v[0] * v[0] / (numb)3.0) - v[1] + I);
            Vnext(w) = v[1] + h * ((v[0] + p[0] - p[1] * v[1]) / p[2]);
			Vnext(i) = p[3] + (fmod((Vnext(t) - p[5]) > (numb)0.0 ? (Vnext(t) - p[5]) : (p[6] / p[7] + p[5] - Vnext(t)), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);
        }
        ...
        ifMETHOD(P(method), SemiExplicitEuler)
        {
            numb I = p[3] + (fmod((v[2] - p[5]) > (numb)0.0 ? (v[2] - p[5]) : (p[6] / p[7] + p[5] - v[2]), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);
            Vnext(v) = v[0] + h * (v[0] - (v[0] * v[0] * v[0] / (numb)3.0) - v[1] + I);
            Vnext(w) = v[1] + h * ((Vnext(v) + p[0] - p[1] * v[1]) / p[2]);
            Vnext(t) = v[2] + h;
        ...
        {
            numb imp = p[3] + (fmod((v[2] - p[5]) > (numb)0.0 ? (v[2] - p[5]) : (p[6] / p[7] + p[5] - v[2]), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);

            numb vmp = v[0] + h * (numb)0.5 * (v[0] - (v[0] * v[0] * v[0] / (numb)3.0) - v[1] + imp);
            numb wmp = v[1] + h * (numb)0.5 * ((v[0] + p[0] - p[1] * v[1]) / p[2]);
            numb tmp = v[2] + h * (numb)0.5;

            numb I = p[3] + (fmod((tmp - p[5]) > (numb)0.0 ? (tmp - p[5]) : (p[6] / p[7] + p[5] - tmp), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);

            Vnext(v) = v[0] + h * (vmp - (vmp * vmp * vmp / (numb)3.0) - wmp + I);
            Vnext(w) = v[1] + h * ((vmp + p[0] - p[1] * wmp) / p[2]);
            Vnext(t) = v[2] + h;
		...
		ifMETHOD(P(method), ImplicitEuler)
		{
			...
			while ((dz > tol) && (nnewt < nnewtmax)) {
				...
				I = p[3] + (fmod((Z[2] - p[5]) > (numb)0.0 ? (Z[2] - p[5]) : (p[6] / p[7] + p[5] - Z[2]), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);

				W[0][N] = v[0] - Z[0] + h * (Z[0] - (Z[0] * Z[0] * Z[0] / (numb)3.0) - Z[1] + I);
				W[1][N] = v[1] - Z[1] + h * ((Z[0] + p[0] - p[1] * Z[1]) / p[2]);
		...
		ifMETHOD(P(method), ImplicitMidpoint)
		{
			...
			while ((dz > tol) && (nnewt < nnewtmax)) {
				...
				I = p[3] + (fmod((a[2] - p[5]) > (numb)0.0 ? (a[2] - p[5]) : (p[6] / p[7] + p[5] - a[2]), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);

				W[0][N] = v[0] - Z[0] + h * (a[0] - (a[0] * a[0] * a[0] / (numb)3.0) - a[1] + I);
				W[1][N] = v[1] - Z[1] + h * ((a[0] + p[0] - p[1] * a[1]) / p[2]);
				W[2][N] = v[2] - Z[2] + h * (numb)1.0;
		...
		ifMETHOD(P(method), ExplicitRungeKutta4)
		{
			...
			for (j = 0; j < 4; j++) {
				...
				k[0][j] = a[0] - (a[0] * a[0] * a[0] / (numb)3.0) - a[1] + I;
				k[1][j] = (a[0] + p[0] - p[1] * a[1]) / p[2];
				k[2][j] = (numb)1.0;

				if (j == 3) {

					Vnext(v) = v[0] + h * (k[0][0] + (numb)2.0 * k[0][1] + (numb)2.0 * k[0][2] + k[0][3]) / (numb)6.0;
					Vnext(w) = v[1] + h * (k[1][0] + (numb)2.0 * k[1][1] + (numb)2.0 * k[1][2] + k[1][3]) / (numb)6.0;
		...
		ifMETHOD(P(method), ExplicitDormandPrince8)
		{
			...
			for (i = 0; i < 13; i++) {
				...
				I = p[3] + (fmod((X1[2] - p[5]) > (numb)0.0 ? (X1[2] - p[5]) : (p[6] / p[7] + p[5] - X1[2]), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);

				k[0][i] = X1[0] - (X1[0] * X1[0] * X1[0] / (numb)3.0) - X1[1] + I;
				k[1][i] = (X1[0] + p[0] - p[1] * X1[1]) / p[2];
				k[2][i] = (numb)1.0;
		...
		{
			numb h1 = (numb)0.5 * h - p[8];
			numb h2 = (numb)0.5 * h + p[8];

			numb I = p[3] + (fmod((v[2] - p[5]) > (numb)0.0 ? (v[2] - p[5]) : (p[6] / p[7] + p[5] - v[2]), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);

			
			numb vmp = v[0] + h1 * (v[0] - (v[0] * v[0] * v[0] / (numb)3.0) - v[1] + I);
			numb wmp = v[1] + h1 * ((v[0] + p[0] - p[1] * v[1]) / p[2]);
			...
			while ((dz > tol) && (nnewt < nnewtmax)) {
				...
				numb I_next = p[3] + (fmod((Vnext(t) - p[5]) > (numb)0.0 ? (Vnext(t) - p[5]) : (p[6] / p[7] + p[5] - Vnext(t)), (numb)1.0 / p[7]) < p[6] / p[7] ? p[4] : (numb)0.0);
				...
				numb f_v = Z[0] - (Z[0] * Z[0] * Z[0] / (numb)3.0) - Z[1] + I_next;
				numb f_w = (Z[0] + p[0] - p[1] * Z[1]) / p[2];

				W[0][2] = vmp - Z[0] + h2 * f_v;
				W[1][2] = wmp - Z[1] + h2 * f_w;
	...
	ifSIGNAL(P(signal), sine)
	{
		...
		{
			numb I = p[3] + p[4] * sin((numb)2.0 * (numb)3.141592653589793 * p[7] * (v[2] - p[5]));
			Vnext(t) = v[2] + h;
			Vnext(v) = v[0] + h * (v[0] - (v[0] * v[0] * v[0] / (numb)3.0) - v[1] + I);
			Vnext(w) = v[1] + h * ((v[0] + p[0] - p[1] * v[1]) / p[2]);
			Vnext(i) = p[3] + p[4] * sin((numb)2.0 * (numb)3.141592653589793 * p[7] * (Vnext(t) - p[5]));
		}
		...
		ifMETHOD(P(method), ExplicitMidpoint)
		{
			numb imp = p[3] + p[4] * sin((numb)2.0 * (numb)3.141592653589793 * p[7] * (v[2] - p[5]));

			numb vmp = v[0] + h * (numb)0.5 * (v[0] - (v[0] * v[0] * v[0] / (numb)3.0) - v[1] + imp);
			numb wmp = v[1] + h * (numb)0.5 * ((v[0] + p[0] - p[1] * v[1]) / p[2]);
			numb tmp = v[2] + h * (numb)0.5;

			numb I = p[3] + p[4] * sin((numb)2.0 * (numb)3.141592653589793 * p[7] * (tmp - p[5]));
		...
		ifMETHOD(P(method), ImplicitEuler)
		{
			...
			while ((dz > tol) && (nnewt < nnewtmax)) {
				...
				I = p[3] + p[4] * sin((numb)2.0 * (numb)3.141592653589793 * p[7] * (Z[2] - p[5]));
		...
		ifMETHOD(P(method), ImplicitMidpoint)
		{
			...
			while ((dz > tol) && (nnewt < nnewtmax)) {
				...
				I = p[3] + p[4] * sin((numb)2.0 * (numb)3.141592653589793 * p[7] * (a[2] - p[5]));
		...
		ifMETHOD(P(method), ExplicitDormandPrince8)
		{
			...
			for (i = 0; i < 13; i++) {
				...
				I = p[3] + p[4] * sin((numb)2.0 * (numb)3.141592653589793 * p[7] * (X1[2] - p[5]));
		...
		ifMETHOD(P(method), VariableSymmetryCD)
		{
			...
			while ((dz > tol) && (nnewt < nnewtmax)) {
				...
				numb I_next = p[3] + p[4] * sin((numb)2.0 * (numb)3.141592653589793 * p[7] * (Vnext(t) - p[5]));
	...
	ifSIGNAL(P(signal), triangle)
	{
		...
		{
			numb I = p[3] + p[4] * (((numb)4.0 * p[7] * (v[2] - p[5]) - (numb)2.0 * floor(((numb)4.0 * p[7] * (v[2] - p[5]) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * p[7] * (v[2] - p[5]) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));
			Vnext(t) = v[2] + h;
			Vnext(v) = v[0] + h * (v[0] - (v[0] * v[0] * v[0] / (numb)3.0) - v[1] + I);
			Vnext(w) = v[1] + h * ((v[0] + p[0] - p[1] * v[1]) / p[2]);
			Vnext(i) = p[3] + p[4] * (((numb)4.0 * p[7] * (Vnext(t) - p[5]) - (numb)2.0 * floor(((numb)4.0 * p[7] * (Vnext(t) - p[5]) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * p[7] * (Vnext(t) - p[5]) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));
		}
		...
		ifMETHOD(P(method), ExplicitMidpoint)
		{
			numb imp = p[3] + p[4] * (((numb)4.0 * p[7] * (v[2] - p[5]) - (numb)2.0 * floor(((numb)4.0 * p[7] * (v[2] - p[5]) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * p[7] * (v[2] - p[5]) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));

			numb vmp = v[0] + h * (numb)0.5 * (v[0] - (v[0] * v[0] * v[0] / (numb)3.0) - v[1] + imp);
			numb wmp = v[1] + h * (numb)0.5 * ((v[0] + p[0] - p[1] * v[1]) / p[2]);
			numb tmp = v[2] + h * (numb)0.5;

			numb I = p[3] + p[4] * (((numb)4.0 * p[7] * (tmp - p[5]) - (numb)2.0 * floor(((numb)4.0 * p[7] * (tmp - p[5]) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * p[7] * (tmp - p[5]) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));
		...
		ifMETHOD(P(method), ImplicitEuler)
		{
			...
			while ((dz > tol) && (nnewt < nnewtmax)) {
				...
				I = p[3] + p[4] * (((numb)4.0 * p[7] * (Z[2] - p[5]) - (numb)2.0 * floor(((numb)4.0 * p[7] * (Z[2] - p[5]) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * p[7] * (Z[2] - p[5]) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));
		...
		ifMETHOD(P(method), ImplicitMidpoint)
		{
			...
			while ((dz > tol) && (nnewt < nnewtmax)) {
				...
				I = p[3] + p[4] * (((numb)4.0 * p[7] * (a[2] - p[5]) - (numb)2.0 * floor(((numb)4.0 * p[7] * (a[2] - p[5]) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * p[7] * (a[2] - p[5]) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));
		...
		ifMETHOD(P(method), ExplicitDormandPrince8)
		{
			...
			for (i = 0; i < 13; i++) {
				...
				I = p[3] + p[4] * (((numb)4.0 * p[7] * (X1[2] - p[5]) - (numb)2.0 * floor(((numb)4.0 * p[7] * (X1[2] - p[5]) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * p[7] * (X1[2] - p[5]) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));
		...
		ifMETHOD(P(method), VariableSymmetryCD)
		{
			...
			while ((dz > tol) && (nnewt < nnewtmax)) {
				...
				numb I_next = p[3] + p[4] * (((numb)4.0 * p[7] * (Vnext(t) - p[5]) - (numb)2.0 * floor(((numb)4.0 * p[7] * (Vnext(t) - p[5]) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * p[7] * (Vnext(t) - p[5]) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));
