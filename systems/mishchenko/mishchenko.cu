...
__host__ __device__ __forceinline__ void finiteDifferenceScheme_(name)(numb* currentV, numb* nextV, numb* parameters)
{
    ifSIGNAL(P(signal), square)
    {
        ...
        numb xmp = fmod(V(x) + H * (numb)0.5 * V(y), (numb)2.0 * (numb)3.141592653589793);
        ...
        Vnext(x) = fmod(V(x) + H * ymp, (numb)2.0 * (numb)3.141592653589793);
    ...
    {
        numb gamp = P(Gammadc) + P(Gammaamp) * sin((numb)2.0 * (numb)3.141592653589793 * P(Gammafreq) * (V(t) - P(Gammadel)));
        numb tmp = V(t) + H * (numb)0.5;
        ...
        Vnext(gamma) = P(Gammadc) + P(Gammaamp) * sin((numb)2.0 * (numb)3.141592653589793 * P(Gammafreq) * (tmp - P(Gammadel)));
        Vnext(t) = V(t) + H;
    ...
    {
        numb gamp = P(Gammadc) + P(Gammaamp) * (((numb)4.0 * P(Gammafreq) * (V(t) - P(Gammadel)) - (numb)2.0 * floor(((numb)4.0 * P(Gammafreq) * (V(t) - P(Gammadel)) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * P(Gammafreq) * (V(t) - P(Gammadel)) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));
        numb tmp = V(t) + H * (numb)0.5;
        ...
        Vnext(gamma) = P(Gammadc) + P(Gammaamp) * (((numb)4.0 * P(Gammafreq) * (tmp - P(Gammadel)) - (numb)2.0 * floor(((numb)4.0 * P(Gammafreq) * (tmp - P(Gammadel)) + (numb)1.0) / (numb)2.0)) * ((int)floor(((numb)4.0 * P(Gammafreq) * (tmp - P(Gammadel)) + (numb)1.0) / (numb)2.0) % 2 == 0 ? (numb)1.0 : (numb)-1.0));
        Vnext(t) = V(t) + H;
