...
__host__ __device__ __forceinline__ void finiteDifferenceScheme_(name)(numb* currentV, numb* nextV, numb* parameters)
{
    ...
    {
        Vnext(x1) = fmod(V(x1) + H * V(x2), (numb)2.0 * (numb)3.141592653589793);
    ...
    {
        numb x1mp = fmod(V(x1) + H * (numb)0.5 * V(x2), (numb)2.0 * (numb)3.141592653589793);
        ...
        Vnext(x1) = fmod(V(x1) + H * x2mp, (numb)2.0 * (numb)3.141592653589793);
        Vnext(sin_x1) = sin(Vnext(x1));
    ...
    ifMETHOD(P(method), ExplicitRungeKutta4)
    {
        ...
        numb x1mp = fmod(V(x1) + H * (numb)0.5 * kx11, (numb)2.0 * (numb)3.141592653589793);
        ...
        x1mp = fmod(V(x1) + H * (numb)0.5 * kx12, (numb)2.0 * (numb)3.141592653589793);
        ...
        x1mp = fmod(V(x1) + H * kx13, (numb)2.0 * (numb)3.141592653589793);
        x2mp = V(x2) + H * kx23;
        x3mp = V(x3) + H * kx33;
        ...
        Vnext(x1) = fmod(V(x1) + H * (kx11 + (numb)2.0 * kx12 + (numb)2.0 * kx13 + kx14) / (numb)6.0, (numb)2.0 * (numb)3.141592653589793);
        Vnext(sin_x1) = sin(Vnext(x1));
    ...
    ifMETHOD(P(method), VariableSymmetryCD)
    {
        ...
        numb x1mp = fmod(V(x1) + h1 * V(x2), (numb)2.0 * (numb)3.141592653589793);
        ...
        Vnext(x1) = fmod(x1mp + h2 * Vnext(x2), (numb)2.0 * (numb)3.141592653589793);
        Vnext(sin_x1) = sin(Vnext(x1));
    }
}
