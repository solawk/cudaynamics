...
namespace attributes
{
    ...
    enum parameters { b, symmetry, method };
...
__device__ __forceinline__ void finiteDifferenceScheme_thomas(numb* currentV, numb* nextV, numb* parameters, Computation* data)
{
