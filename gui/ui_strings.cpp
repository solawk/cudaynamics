...
std::string plottypes[] = { "Variables time series", "3D Phase diagram", "2D Phase diagram", "Orbit diagram", 
    "Heatmap", "RGB Heatmap", "Indices diagram", "Indices time series", "Decay plot", "Recurrence plot", "Topology Data Analysis" };
